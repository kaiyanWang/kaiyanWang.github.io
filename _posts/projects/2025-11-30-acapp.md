...
找到`acapp/game/templates/multiends/web.html`，该文件引入了`<script src="{% static 'js/dist/game.js' %}"></script>`（/acapp/scripts/compress_game_js.sh脚本将js/src/下的js文件打包得到一个js/dist/game.js文件，减少http请求js文件的数量）
