...
3、编写同步函数
create_player、move_to、shoot_fineball、attack、blink
...
启动Django后端：python3 manage.py runserver 0.0.0.0:8000
启动联机服务：daphne -b 0.0.0.0 -p 5015 acapp.asgi:application
将所有的js文件打包：./scripts/compress_game_js.sh